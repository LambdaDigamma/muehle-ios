...
private let SharedHeuristicStrongInstance = HeuristicStrong()

class HeuristicStrong: Heuristic {
    
    fileprivate init() {
        
    }
    
    static func shared() -> HeuristicStrong {
        return SharedHeuristicStrongInstance
    }
    ...
    func evaluate(game: Game) -> Int {
        ...
        let factorMovesBlack = 2570
        let factorMovesWhite = 2570
        let factorStonesBlack = 10000
        let factorStonesWhite = 10000
        let factorPotentialBlack = 1030
        let factorPotentialWhite = 1030
        var whiteAddition = 0
        var blackAddition = 0
