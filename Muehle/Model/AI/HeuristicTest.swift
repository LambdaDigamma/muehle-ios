...
private let SharedHeuristicTestInstance = HeuristicTest()

class HeuristicTest: Heuristic {
    
    fileprivate init() {
        
    }
    
    static func shared() -> HeuristicTest {
        return SharedHeuristicTestInstance
    }
    ...
    func evaluate(game: Game) -> Int {
        ...
        let factorMovesBlack = 2970
        let factorMovesWhite = 2970
        let factorStonesBlack = 10000
        let factorStonesWhite = 10000
        let factorPotentialBlack = 2030
        let factorPotentialWhite = 2030
        var whiteAddition = 0
        var blackAddition = 0
